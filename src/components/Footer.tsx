        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-[#94A3B8] text-sm leading-relaxed">
              Tunisia's premium rental real estate platform. Find your perfect home with ease.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2.5">
                ...
                <span className="text-[#94A3B8] text-sm">Avenue Habib Bourguiba, 1000 Tunis, Tunisia</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Phone size={16} className="text-[#2563EB] flex-shrink-0" />
                <span className="text-[#94A3B8] text-sm">+216 71 234 567</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail size={16} className="text-[#2563EB] flex-shrink-0" />
                <span className="text-[#94A3B8] text-sm">hello@nestfinder.tn</span>
              </li>
              <li className="flex items-center gap-2.5">
