...
const CONTACT_INFO = [
  { icon: MapPin, label: "Address", value: "12 Rue de la Paix, 75001 Paris, France", color: "#2563EB" },
  { icon: Phone, label: "Phone", value: "+33 1 23 45 67 89", color: "#10B981" },
  { icon: Mail, label: "Email", value: "hello@nestfinder.fr", color: "#F59E0B" },
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-[#E2E8F0] overflow-hidden">
            ...
            <div className="p-4 bg-[#EFF6FF] border-t border-[#BFDBFE] flex items-center gap-2">
              ...
              <span className="text-[#2563EB] text-sm font-medium">12 Rue de la Paix, Paris</span>
            </div>
          </div>
